...
import { ChatMessage, ChatMessageError, ChatTTS } from '@/types/message';
...
export class ServerService implements IMessageService {
  ...
  updateMessageTranslate(id: string, translate: Partial<ChatMessage> | false): Promise<any> {
    return lambdaClient.message.updateTranslate.mutate({ id, value: translate });
  }
